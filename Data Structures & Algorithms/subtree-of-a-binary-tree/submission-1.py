...
Runtime: O(#items subtree * # items maintree)
Space Complexity: O(height main tree + heigh small tree)
    # space is maximum vars at a singlle point in time
    at one time, sameTree has height of small tree (recuriosn tacks)
        and the recurison stacks ofte outer loop --> add them not multiplyu 
